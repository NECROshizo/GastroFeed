    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(db_comment='Цвет в HEX-формате', help_text='Используйте цвет в формате HEX', max_length=7, unique=True, validators=[django.core.validators.RegexValidator(regex='#[A-F0-9]{6}$')], verbose_name='Цвет')),
                ('slug', models.SlugField(db_comment='Slug для цвета', help_text='Используйте slug состаящий из латинских букв, цифр и символа _', max_length=200, unique=True, validators=[django.core.validators.RegexValidator(regex='^[-a-zA-Z0-9_]+$')], verbose_name='Слаг')),
            ],
            options={
                'verbose_name': 'Тег',
