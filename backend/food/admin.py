...
class RecipesAdmin(admin.ModelAdmin):
    ...
    def show_preview(self, obj: Recipes):
        images_column = format_html(
    ...
    def show_tags(self, obj: Recipes):
        tags_column = format_html_join(
            ', ', '<span style="color:{}">{}</span>',
    ...
    def show_ingredients(self, obj: Recipes):
        ingredients_query_set = sorted(
